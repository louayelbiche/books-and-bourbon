  ...
  getOrStartConversation(sessionId, metadata) {
    ...
    try {
      ...
      `).run(
        ...
        sessionId,
        this.sourceApp,
        (metadata == null ? void 0 : metadata.websiteUrl) ?? null,
        (metadata == null ? void 0 : metadata.websiteDomain) ?? null,
        (metadata == null ? void 0 : metadata.locale) ?? null,
        (metadata == null ? void 0 : metadata.custom) ? JSON.stringify(metadata.custom) : "{}",
        now,
        now,
        now
      );
